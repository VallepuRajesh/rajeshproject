...
class Management:
    def __init__(self, root):
        ...
        # self.auth_plugin = cr.auth_plugin
        ...
        cursor.execute("create table  if not exists student_register ( f_name VARCHAR(50) NOT NULL, l_name VARCHAR(50) NOT NULL, course "
                       "VARCHAR(30) NOT NULL, subject VARCHAR(50) NOT NULL, year Int(10) NOT NULL, age Int(10) NOT NULL, "
                       "gender char(10) NOT NULL, birth DATE NOT NULL, contact VARCHAR(15) NOT NULL, email VARCHAR(100) NOT NULL, "
                       "PRIMARY KEY ( contact ) );")
        connection.close()
                ...
                if row != None:
                    ...
                    curs.execute(
                        ...
                        (
                            ...
                            self.age_entry.get(),
                            self.gender_entry.get(),
                            datetime.strptime(self.birth_entry.get(),'%m-%d-%Y'),
